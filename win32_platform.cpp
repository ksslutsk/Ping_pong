...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int  nShowCmd) 
{
	...
	window_class.lpszClassName = L"Game Window Class";// L?
	...
	//створити вікно
	HWND window =  CreateWindow(window_class.lpszClassName, L"Ping - Pong!", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT,
